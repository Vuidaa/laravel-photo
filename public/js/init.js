		...
		// Scrolly.
			...
			//Images rollover
				$('.current').mouseover(function(){
					...
					var selectedImageWrap = $(this).parent();

					$(this).stop().fadeTo("fast", 0,function(){

						$(selectedImageWrap).find('.current').attr('src',$(selectedImageWrap).find('.before').attr('src')); 

						$(selectedImageWrap).find('.current').stop().fadeTo('fast',1);
					});
				});
				...
				$('.current').mouseout(function(){
					...
					$(this).stop().fadeTo('fast',0,function(){
						...
						$(selectedImageWrap).find('.current').attr('src',$(selectedImageWrap).find('.after').attr('src')); 
			...
			//Colorbox gallery
			$('.colorbox-gallery').colorbox({scalePhotos: true, maxWidth:'90%', maxHeight:'90%'});
